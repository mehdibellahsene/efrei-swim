...
import { getAllArticles } from "@/lib/supabase-api"
            ...
            >
              ...
              <div className="flex items-center gap-4 rounded-lg border border-border/40 bg-background/60 backdrop-blur p-4 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Séances par semaine</p>
                </div>
              </div>
              <div className="flex items-center gap-4 rounded-lg border border-border/40 bg-background/60 backdrop-blur p-4 shadow-sm sm:col-span-2 lg:col-span-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Médailles remportées</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto flex flex-col items-center justify-between gap-6 md:flex-row px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3">
            <div className="flex flex-col gap-2">
              <p className="font-medium text-sm">Club</p>
              <Link href="/a-propos" className="text-sm text-muted-foreground hover:text-foreground transition-colors">À propos</Link>
              <Link href="/equipe" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Notre équipe</Link>
              <Link href="/contact" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Contact</Link>
            </div>
            <div className="flex flex-col gap-2">
              <p className="font-medium text-sm">Légal</p>
              <Link href="/mentions-legales" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Mentions légales</Link>
              <Link href="/confidentialite" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Confidentialité</Link>
            </div>
